...
public class SpawnInfo {
	...
	public RarityMultiplier[] getRarityMultipliers() {
		return rarityMultipliers;
	}
	public void setRarityMultipliers(RarityMultiplier[] rarityMultipliers) {
	...
	public String[] getStringLocationTypes() {
		return stringLocationTypes;
	}
	public void setStringLocationTypes(String[] stringLocationTypes) {
		this.stringLocationTypes = stringLocationTypes;
	}
